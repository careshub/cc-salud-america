...
<?php
    ...
    <div class="taxonomy-policies">
        ...
        <div class="archive-filter-container background-light-gray">
            See&emsp;<a href="<?php sa_the_cpt_tax_intersection_link( 'resources', 'sa_advocacy_targets', $tax_term->slug ); ?>" class="post-type-flag saresources">SA! Resources</a> <a href="<?php sa_the_cpt_tax_intersection_link( 'heroes', 'sa_advocacy_targets', $tax_term->slug ); ?>" class="post-type-flag sa_success_story">Salud Heroes</a> or <a href="<?php echo trailingslashit( sa_get_section_permalink( 'big_bets' ) ) . $tax_term->slug; ?>">all posts</a> in this topic.
        </div>
        <?php bp_get_template_part( 'groups/single/sapolicies/policy-loop' ); ?>
    </div>
    <?php
